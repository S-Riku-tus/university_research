...
> **9/15追加比較後の更新先**: 出力の読み方は実装時点の記録。最新は単体chunkの説明、fold内WAVマスク、IG積分不整合、回帰のdeletion/insertion面積を区別する。 最新の[比較解析](../../experiments/2026-09-15_onb_frequency_comparison/analysis.md)、[本人の研究仮説](2026-09-15_master_thesis_hypothesis.md)、[解析手順](../analysis_workflow.md)を参照する。以下の本文は当時の記録として保持する。

...
> **9/15追加比較後の更新先**: 本文の「確定」は当時の手法選定。現在はTreeSHAP・IG・Grad-CAM・共通マスクを出力済みだが、IGの数値整合は未解決。手法選定と説明としての検証完了を分ける。 最新の[比較解析](../../experiments/2026-09-15_onb_frequency_comparison/analysis.md)、[本人の研究仮説](2026-09-15_master_thesis_hypothesis.md)、[解析手順](../analysis_workflow.md)を参照する。以下の本文は当時の記録として保持する。

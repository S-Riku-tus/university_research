...
> **9/15追加比較後の更新先**: 当時のRF優位・全モデル共通帯域・ONBを副評価へ回す提案は現行方針へ引き継がない。log-power後の順位と帯域は異なり、本人はアンサンブルの劣化抑制とその原因を中心仮説として指定している。 最新の[比較解析](../../experiments/2026-09-15_onb_frequency_comparison/analysis.md)、[本人の研究仮説](2026-09-15_master_thesis_hypothesis.md)、[解析手順](../analysis_workflow.md)を参照する。以下の本文は当時の記録として保持する。

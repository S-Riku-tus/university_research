...
更新日: **2026-09-18（ONB全35条件run 151715を解析し、時間区間マスクを廃止）**。ピーク高さ選別、別日分割、後期計画は維持。分位点ルール時点の状態は[変更前の記録](../experiments/2026-09-16_peak_height_selection/previous_documents/research_status.md)に保存した。

...
| 記録 | 範囲・用途 |
|---|---|
| [9/16・別日分割と音響選別](2026-09-16_day_split_spectral_selection/README.md) | 最新方針。6/11+7/9学習・6/18テスト、通常KFoldの性能重み、2,940秒スペクトル、学習1,648秒・テスト全1,080秒、実3モデルの2 epochs動作確認。本性能は未検証 |

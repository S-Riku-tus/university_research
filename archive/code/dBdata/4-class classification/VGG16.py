...
# val-lossグラフの保存先フォルダ
SAVE_PATH = r"C:\Users\Casper4\Python\Ueki\shibasaki\研究\6月26日_サブクール度10度_0.3mm\training_results\VGG16"
...
def vgg16(input_shape, num_classes):
    base_model = VGG16(weights=None, include_top=False, input_shape=input_shape)  # ImageNetの重みを使用しない
...
# モデルの作成
model = vgg16(input_shape=(224, 224, 3), num_classes=4)

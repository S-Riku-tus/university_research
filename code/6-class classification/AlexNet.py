...
# 特徴量データの読み込み
TRAIN_PATH = r"C:\Users\Casper4\Python\Ueki\shibasaki\研究\6月26日_サブクール度10度_0.3mm\スペクトログラム"

# val-lossグラフの保存先フォルダ
SAVE_PATH = r"C:\Users\Casper4\Python\Ueki\shibasaki\研究\6月26日_サブクール度10度_0.3mm\training_results\6クラス分類\AlexNet"
...
# モデルの作成
model = alexnet(input_shape=(224, 224, 3), num_classes=6)

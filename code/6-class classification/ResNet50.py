...
# val-lossグラフの保存先フォルダ
SAVE_PATH = r"C:\Users\Casper3\Python\Ueki\shibasaki\研究\6月26日_サブクール度10度_0.3mm\training_results\6クラス分類\ResNet50"
...
def resnet50(input_shape, num_classes):
    ...
    # 全結合層を追加
    x = base_model.output
    x = GlobalAveragePooling2D()(x)  # 各チャンネルの画素平均を求め、それをまとめるため重みの数が少なくて済む
...
# ResNet50モデルの構築
model = resnet50(input_shape=(224, 224, 3), num_classes=6)
